...
<table class="ls">
    <tr>
        <td colspan="5"><a href="<?php echo U('China/Project/projectAdd');?>" class="btn_s">添加</a></td>
    </tr>
    <tr>
        <th width="5%">id</th>
        <th width="10%">项目名称</th>
    ...
    <?php if(is_array($oneInfo)): $i = 0; $__LIST__ = $oneInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		...
		<td>
			<a href="<?php echo U('China/Project/projectEdit', array('id'=>$vo['id']));?>">编辑</a>&nbsp;
			<a href="<?php echo U('China/Project/delproject', array('id'=>$vo['id']));?>">删除</a>
		</td>
