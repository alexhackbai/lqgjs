...
<table class="ls">
	<tr>
		<th width="5%">id</th><th width="10%">姓名</th><th width="15%">电话</th><th width="45%">内容</th><th width="15%">时间</th><th width="10%">操作</th>
	</tr>
	<?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["name"]); ?></td><td><?php echo ($vo["tel"]); ?></td><td><?php echo ($vo["content"]); ?></td><td><?php echo (date('Y-m-d H:i:s', $vo["ctime"])); ?></td>
		<td><a href="<?php echo U('China/Contact/delMessage', array('id'=>$vo['id']));?>">删除</a></td>
