...
<table class="ls">
	<tr>
		<td colspan="5"><a href="<?php echo U('China/News/serviceAdd');?>" class="btn_s">添加</a></td>
	</tr>
	<tr>
	...
	<?php if(is_array($serviceInfo)): $i = 0; $__LIST__ = $serviceInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		...
		<td>
			<a href="<?php echo U('China/News/serviceEdit', array('id'=>$vo['id']));?>">编辑</a>&nbsp;
			<a href="<?php echo U('China/News/delService', array('id'=>$vo['id']));?>">删除</a>
		</td>
