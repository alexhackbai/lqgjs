...
<body>
<form method="post" action="<?php echo U('China/Service/doServiceEdit');?>" enctype="multipart/form-data">
<input type="hidden" name="id" value="<?php echo ($info['id']); ?>" />
<input type="hidden" name="cover_id" value="<?php echo ($info['cover_id']); ?>" />
<table class="form">
	<tr>
