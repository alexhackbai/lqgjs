...
<table class="ls">
    <tr>
        <td colspan="5"><a href="<?php echo U('China/Service/serviceAdd');?>" class="btn_s">添加</a></td>
    </tr>
    <tr>
        <th width="5%">id</th>
        <th width="20%">服务名称</th>
    ...
    <?php if(is_array($serviceInfo)): $i = 0; $__LIST__ = $serviceInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["id"]); ?></td>
        <td><?php echo ($vo["pro_name"]); ?></td>
        <td><?php echo ($vo["home"]); ?></td>
        <td><?php echo ($vo["desc"]); ?></td>
		<td>
			<a href="<?php echo U('China/Service/serviceEdit', array('id'=>$vo['id']));?>">编辑</a>&nbsp;
			<a href="<?php echo U('China/Service/delService', array('id'=>$vo['id']));?>">删除</a>
		</td>
