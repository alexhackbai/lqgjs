...
<table class="ls">
	<tr>
		<td colspan="4"><a href="<?php echo U('China/Ad/adTypeAdd');?>" class="btn_s">添加</a></td>
	</tr>
	<tr>
		<th width="5%">id</th><th width="25%">广告位</th><th width="70%">操作</th>
	</tr>
	<?php if(is_array($adTypeInfo)): $i = 0; $__LIST__ = $adTypeInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["name"]); ?></td>
		<td>
			<a href="<?php echo U('China/Ad/adTypeEdit', array('id'=>$vo['id']));?>">编辑</a>&nbsp;
		</td>
