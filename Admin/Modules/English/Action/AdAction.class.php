<?php
// 本类由系统自动生成，仅供测试用途
class AdAction extends EnglishAction {
    ...
    public function doAdAdd()
    {
        ...
        $id = D('Ad')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/Ad/ad'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doAdEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Ad/adEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/Ad/adEdit', array('id'=>$id)));
        }
    }
    ...
    public function delAd()
    {
        ...
        if (!empty($result)) {
            $this->success('信息删除成功!', U('English/Ad/ad'));
        } else {
            $this->error('信息删除失败!');
        }
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doAdTypeAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/Ad/adType'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doAdTypeEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Ad/adTypeEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/Ad/adTypeEdit', array('id'=>$id)));
        }
    }
}