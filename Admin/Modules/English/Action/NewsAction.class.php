<?php
// 本类由系统自动生成，仅供测试用途
class NewsAction extends EnglishAction {
    ...
    public function doBusinessAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/News/business'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doBusinessEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/News/businessEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/News/businessEdit', array('id'=>$id)));
        }
    }
    ...
    public function delBusiness()
    {
        ...
        if (!empty($result)) {
            $this->success('信息删除成功!', U('English/News/business'));
        } else {
            $this->error('信息删除失败!');
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doServiceAdd()
    {
        ...
        $id = D('News')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/News/service'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doServiceEdit()
    {
        ...
        $result = D('News')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/News/serviceEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/News/serviceEdit', array('id'=>$id)));
        }
    }
    ...
    public function delService()
    {
        ...
        $result = D('News')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('English/News/service'));
        } else {
            $this->error('信息删除失败!');
        }
    }
...
public function news()
    ...
    public function doNewsAdd()
    {
        ...
        $id = D('News')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/News/news'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doNewsEdit()
    {
        ...
        $result = D('News')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/News/newsEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/News/newsEdit', array('id'=>$id)));
        }
    }
    ...
    public function delNews()
    {
        ...
        $result = D('News')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('English/News/news'));
        } else {
            $this->error('信息删除失败!');
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doTypeAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('English/News/type'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doTypeEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/News/typeEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('English/News/typeEdit', array('id'=>$id)));
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
