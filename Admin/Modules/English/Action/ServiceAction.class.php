...
class ServiceAction extends EnglishAction {
    ...
    public function doOne()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Service/one'));
        } else {
            $this->error('信息处理失败!', U('English/Service/one'));
        }
    }
    ...
    public function doTwo()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Service/two'));
        } else {
            $this->error('信息处理失败!', U('English/Service/two'));
        }
    }
    ...
    public function doThree()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Service/three'));
        } else {
            $this->error('信息处理失败!', U('English/Service/three'));
        }
    }
    ...
    public function doFour()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('English/Service/four'));
        } else {
            $this->error('信息处理失败!', U('English/Service/four'));
        }
    }
