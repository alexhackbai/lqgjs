...
class NewsAction extends LandAction {
    ...
    public function doBusinessAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/News/business'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doBusinessEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/News/businessEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/News/businessEdit', array('id'=>$id)));
        }
    }
    ...
    public function delBusiness()
    {
        ...
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/News/business'));
        } else {
            $this->error('信息删除失败!');
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doServiceAdd()
    {
        ...
        $id = D('News')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/News/service'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doServiceEdit()
    {
        ...
        $result = D('News')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/News/serviceEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/News/serviceEdit', array('id'=>$id)));
        }
    }
    ...
    public function delService()
    {
        ...
        $result = D('News')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/News/service'));
        } else {
            $this->error('信息删除失败!');
        }
    }
...
public function news()
    ...
    public function doNewsAdd()
    {
        ...
        $id = D('News')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/News/news'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doNewsEdit()
    {
        ...
        $result = D('News')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/News/newsEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/News/newsEdit', array('id'=>$id)));
        }
    }
    ...
    public function delNews()
    {
        ...
        $result = D('News')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/News/news'));
        } else {
            $this->error('信息删除失败!');
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doTypeAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/News/type'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doTypeEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/News/typeEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/News/typeEdit', array('id'=>$id)));
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////
