<?php
// 本类由系统自动生成，仅供测试用途
class CaseAction extends LandAction {
    ...
    public function doOneAdd()
    {
        ...
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/Case/one'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doOneEdit()
    {
        ...
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/Case/oneEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/Case/oneEdit', array('id'=>$id)));
        }
    }
    ...
    public function delOne()
    {
        ...
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/Case/one'));
        } else {
            $this->error('信息删除失败!');
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doTwoAdd()
    {
        ...
        $id = D('Case')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/Case/two'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doTwoEdit()
    {
        ...
        $result = D('Case')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/Case/twoEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/Case/twoEdit', array('id'=>$id)));
        }
    }
    ...
    public function delTwo()
    {
        ...
        $result = D('Case')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/Case/two'));
        } else {
            $this->error('信息删除失败!');
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doThreeAdd()
    {
        ...
        $id = D('Case')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/Case/three'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doThreeEdit()
    {
        ...
        $result = D('Case')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/Case/threeEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/Case/threeEdit', array('id'=>$id)));
        }
    }
    ...
    public function delThree()
    {
        ...
        $result = D('Case')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/Case/three'));
        } else {
            $this->error('信息删除失败!');
        }
    }
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function doFourAdd()
    {
        ...
        $id = D('Case')->add($insert);
        if (!empty($id)) {
            $this->success('信息处理成功!', U('Land/Case/four'));
        } else {
            $this->error('信息处理失败!');
        }
    }
    ...
    public function doFourEdit()
    {
        ...
        $result = D('Case')->where('id ='.$id)->save($update);
        if (!empty($result)) {
            $this->success('信息处理成功!', U('Land/Case/fourEdit', array('id'=>$id)));
        } else {
            $this->error('信息处理失败!', U('Land/Case/fourEdit', array('id'=>$id)));
        }
    }
    ...
    public function delFour()
    {
        ...
        $result = D('Case')->delete($id);
        if (!empty($result)) {
            $this->success('信息删除成功!', U('Land/Case/four'));
        } else {
            $this->error('信息删除失败!');
        }
    }
