...
<div class="logo_nav clearfix">
    ...
    <div class="nav fr">
    	<ul class="clearfix">
        	<li><a href="<?php echo U('China/Index/index');?>">首页</a></li>
            <li><a href="<?php echo U('China/About/index');?>">关于我们</a></li>
            <li><a href="<?php echo U('China/News/index');?>" class="current">奇嘉动态</a></li>
...
<div class="sub_banner">
	<div class="sub_banner_box clearfix">
    	<div class="fl inline mt30">
        	<h3 class="cn">奇嘉动态</h3>
            <h3 class="en">Qijia News</h3>
        </div>
        <p class="fr">我们坚信敏锐的洞察与创新设计创造商机、未来！</p>
    </div>
</div>

<div class="main clearfix pt20">
	<div class="detail fl">
    	<h3 class="tit">奇嘉动态</h3>
        <div class="news_ls">
        	<ul>
				<?php if(is_array($resultInfo)): $i = 0; $__LIST__ = $resultInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">
                	<div class="pic fl"><img src="__ROOT__<?php echo ($vo['cover']); ?>" /></div>
                    <div class="txt fr">
                    	<h4><a href="<?php echo ($vo['link']); ?>"><?php echo ($vo["title"]); ?></a></h4>
                        <div class="time"><?php echo (date('Y年m月d日', $vo["ctime"])); ?>&nbsp;&nbsp;浏览次数：<?php echo ($vo["views"]); ?>次</div>
                        <p><?php echo ($vo["desc"]); ?><a href="<?php echo ($vo['link']); ?>">阅读更多&gt;&gt;</a></p>
                    </div>
                    <div class="clear"></div>
    ...
    <div class="side_right fr">
    	<h3 class="tit">奇嘉动态</h3>
        <ul class="related">
        	<?php if(is_array($newsLs)): $i = 0; $__LIST__ = $newsLs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo['link']); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
