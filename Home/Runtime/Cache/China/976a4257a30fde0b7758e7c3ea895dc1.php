    ...
    <div class="warp clearfix">
        ...
        <div class="rightContentPane right">
            ...
            <div class="breadCrumb">
                 <a href="<?php echo U('China/Index/index');?>">首页</a>&rsaquo;联系我们
            </div>
            <div class="rightBotPane">
                <h2>联系我们</h2>
                <ul>
                    <li>地址：<?php echo ($siteInfo["site_address"]); ?></li>
                    <li>邮编：</th><td><?php echo ($siteInfo["site_code"]); ?></li>
                    <li>电话：</th><td><?php echo ($siteInfo["site_tel"]); ?></li>
                    <li>邮箱</th><td><?php echo ($siteInfo["site_tel"]); ?></li>
                     <li>电话：</th><td><?php echo ($siteInfo["site_mail"]); ?></li>
                      <li>技术支持：</th><td><?php echo ($siteInfo["site_help"]); ?></li>
                </ul>
             
                <br />
                    <form id="contactform" method="post" action="<?php echo U('China/Contact/message');?>" enctype="multipart/form-data">               
                    <ol>
                        <li>
                            <label for="name">姓名<a href="#">*</a><br>
                            </label>
                            <input name="name" class="text" id="name">
                        </li>
                        <li>
                            <label for="label2">电话<a href="#">*</a><br>
                            </label>
                            <input id="tel" name="tel" class="text">
                        </li>
                      
                        <li>
                            <label for="message">留言<a href="#">*</a><br>
                            </label>
                            <textarea id="content" name="content" rows="6" cols="50"></textarea>
                        </li>
                        <li class="buttons">
                            <input type="submit" name="imageField2" id="imageField2" value="发送信息" >
                        </li>
                    </ol>
                </form>
            </div>
