    ...
    <div class="warp clearfix">
        <div class="leftNav left">
             <ul>
                ...
                <li><a href="#">产品</a>
                    <ul>
                    <?php if(is_array($caseInfoList)): $i = 0; $__LIST__ = $caseInfoList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
        ...
        <div class="rightContentPane right">
            ...
            <div class="breadCrumb">
                <a href="<?php echo U('China/Index/index');?>">首页</a>&rsaquo;服务
            </div>
            <div class="rightBotPane">
                <h2><?php echo ($detailInfo["pro_name"]); ?></h2>
                <p>描述：<?php echo ($detailInfo["desc"]); ?></p>
               <p><img src="__ROOT__<?php echo ($detailInfo['cover']); ?>" width="400px" height="400px" /></p>
                <p>内容：<?php echo ($detailInfo["content"]); ?></p>
